...
# If omitted, Audiogen will auto-select OpenAI when an OPENAI_API_KEY is set.
...
Open http://localhost:3000, type a description like “granular riser with metallic swells”, and Audiogen will render a new waveform using the configured provider.
